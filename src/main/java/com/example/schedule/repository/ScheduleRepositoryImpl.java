...
public class ScheduleRepositoryImpl implements ScheduleRepository {
    ...
    public List<ScheduleResponseDto> findByName(String name) {
        return jdbcTemplate.query("select * from schedule where name = ? order by edit_date desc",
                scheduleResponseDtoRowMapper(), name);
    }

    @Override
    public List<ScheduleResponseDto> findByEditDate(LocalDateTime editDate) {
        return jdbcTemplate.query("select * from schedule where edit_date = ? order by edit_date desc",
